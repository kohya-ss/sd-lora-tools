...
# This code copied from sd-scripts.
# Original code is based off the extract_lora_from_models.py file which is based on https://github.com/cloneofsimo/lora/blob/develop/lora_diffusion/cli_svd.py
...
def extract_conv(weight, lora_rank, dynamic_method, dynamic_param, device, scale: float = 1):
...
def extract_linear(weight, lora_rank, dynamic_method, dynamic_param, device, scale: float = 1):
...
def rank_resize(S, rank, dynamic_method, dynamic_param, scale: float = 1):
    param_dict = {}
